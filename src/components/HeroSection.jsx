    ...
    <section className="relative h-screen w-full overflow-hidden bg-brand-black flex items-center justify-center">
      ...
      <div className="relative z-10 text-center px-4 max-w-6xl">
        ...
        >
          ...
          <span className="inline-block whitespace-nowrap text-brand-gold">
            {"Tastes".split("").map((char, j) => (
              <motion.span key={j} variants={letterAni} className="inline-block italic">
                {char}
              </motion.span>
            ))}
          </span>
